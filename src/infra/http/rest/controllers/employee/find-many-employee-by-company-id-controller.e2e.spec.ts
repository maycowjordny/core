...
describe("Find many employee by companyId test(e2e)", () => {
    ...
    it("should be able to find a employee by companyId", async () => {
        ...
        const response = await request(app.server).get("/employee")
